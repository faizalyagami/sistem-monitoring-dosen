                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="tetap"
                                            {{ old('status', $dosen->status) == 'tetap' ? 'selected' : '' }}>Tetap</option>
                                        <option value="kontrak"
                                            {{ old('status', $dosen->status) == 'kontrak' ? 'selected' : '' }}>Kontrak
                                        </option>
                                        <option value="luar_biasa"
                                            {{ old('status', $dosen->status) == 'luar_biasa' ? 'selected' : '' }}>Luar
                                            Biasa</option>
                                        <option value="pensiun"
                                            {{ old('status', $dosen->status) == 'pensiun' ? 'selected' : '' }}>Pensiun
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback small">{{ $message }}</div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mt-2">
                                        @if ($dosen->photo)
                                            <img src="{{ $dosen->photo_url }}" class="img-thumbnail" width="150"
                                                id="currentPhoto">
                                        @endif
