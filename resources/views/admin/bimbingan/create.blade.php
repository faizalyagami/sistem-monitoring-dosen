        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.bimbingan.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="jenis_bimbingan" id="jenis_bimbingan"
                                        ...
                                        <option value="skripsi" {{ old('jenis_bimbingan') == 'skripsi' ? 'selected' : '' }}>
                                            Skripsi (S1)</option>
                                        <option value="tesis" {{ old('jenis_bimbingan') == 'tesis' ? 'selected' : '' }}>
                                            Tesis (S2)</option>
                                        <option value="disertasi"
                                            {{ old('jenis_bimbingan') == 'disertasi' ? 'selected' : '' }}>Disertasi (S3)
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="kategori_bimbingan" id="kategori_bimbingan"
                                        ...
                                        <option value="Pembimbing Utama"
                                            {{ old('kategori_bimbingan') == 'Pembimbing Utama' ? 'selected' : '' }}>
                                        ...
                                        <option value="Penguji"
                                            {{ old('kategori_bimbingan') == 'Penguji' ? 'selected' : '' }}>Penguji</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="tahun_akademik" id="tahun_akademik"
                                        ...
                                        value="{{ old('tahun_akademik', date('Y')) }}" min="2000" max="2100"
                                        required>
