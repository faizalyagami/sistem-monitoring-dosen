...
@section('content')
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.pengajaran.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="kode_mk" id="kode_mk"
                                        ...
                                        value="{{ old('kode_mk') }}" placeholder="Contoh: IF101" required>
                                    @error('kode_mk')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_mk" id="nama_mk"
                                        ...
                                        value="{{ old('nama_mk') }}" placeholder="Contoh: Algoritma dan Pemrograman"
                                        required>
                                    @error('nama_mk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="bidang_keilmuan" id="bidang_keilmuan"
                                        ...
                                        value="{{ old('bidang_keilmuan') }}" placeholder="Contoh: Ilmu Komputer" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="kelas" id="kelas"
                                        ...
                                        value="{{ old('kelas') }}" placeholder="Contoh: A, B, C, D" required>
                                    @error('kelas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="jumlah_mahasiswa" id="jumlah_mahasiswa"
                                        ...
                                        value="{{ old('jumlah_mahasiswa') }}" placeholder="Jumlah mahasiswa dalam kelas"
                                        required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="tahun_akademik" id="tahun_akademik"
                                        ...
                                        value="{{ old('tahun_akademik', date('Y')) }}" placeholder="Contoh: 2024"
                                        required>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('admin.pengajaran.index') }}" class="btn btn-secondary">
    ...
    <script>
        ...
        document.getElementById('academic_period_id').addEventListener('change', function() {
            ...
            // Extract year from period name (example: "Semester Ganjil 2024/2025")
