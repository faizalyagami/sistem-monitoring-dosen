        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.pengajaran.update', $pengajaran->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="kode_mk" id="kode_mk"
                                        ...
                                        value="{{ old('kode_mk', $pengajaran->kode_mk) }}" required>
                                    @error('kode_mk')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_mk" id="nama_mk"
                                        ...
                                        value="{{ old('nama_mk', $pengajaran->nama_mk) }}" required>
                                    @error('nama_mk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="bidang_keilmuan" id="bidang_keilmuan"
                                        ...
                                        value="{{ old('bidang_keilmuan', $pengajaran->bidang_keilmuan) }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="kelas" id="kelas"
                                        ...
                                        value="{{ old('kelas', $pengajaran->kelas) }}" required>
                                    @error('kelas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="sks" id="sks"
                                        ...
                                        <option value="4" {{ old('sks', $pengajaran->sks) == 4 ? 'selected' : '' }}>4
                                            SKS</option>
                                        <option value="6" {{ old('sks', $pengajaran->sks) == 6 ? 'selected' : '' }}>6
                                            SKS</option>
                                    </select>
                                    @error('sks')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="jumlah_mahasiswa" id="jumlah_mahasiswa"
                                        ...
                                        value="{{ old('jumlah_mahasiswa', $pengajaran->jumlah_mahasiswa) }}" required>
