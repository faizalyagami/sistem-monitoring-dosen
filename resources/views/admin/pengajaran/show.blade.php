        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        <a href="{{ route('admin.pengajaran.edit', $pengajaran->id) }}" class="btn btn-warning">
                ...
                <!-- Delete Form -->
                <form id="delete-form" action="{{ route('admin.pengajaran.destroy', $pengajaran->id) }}" method="POST"
                    style="display: none;">
                    @csrf
                    @method('DELETE')
                </form>
