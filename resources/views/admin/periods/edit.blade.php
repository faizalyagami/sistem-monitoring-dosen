                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white">
                        <h5 class="mb-0 fw-bold">
                            <i class="bi bi-pencil-square me-2"></i> Edit Periode Akademik
                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.periods.update', $period->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="semester" id="semester"
                                        ...
                                        <option value="ganjil"
                                            {{ old('semester', $period->semester) == 'ganjil' ? 'selected' : '' }}>Ganjil
                                        </option>
                                        <option value="genap"
                                            {{ old('semester', $period->semester) == 'genap' ? 'selected' : '' }}>Genap
                                        </option>
                                    </select>
                                    @error('semester')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="tahun_awal" id="tahun_awal"
                                        ...
                                        value="{{ old('tahun_awal', $period->tahun_awal) }}" required>
                                    @error('tahun_awal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="tahun_akhir" id="tahun_akhir"
                                        ...
                                        value="{{ old('tahun_akhir', $period->tahun_akhir) }}" required>
                                    @error('tahun_akhir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="tanggal_mulai" id="tanggal_mulai"
                                        ...
                                        value="{{ old('tanggal_mulai', $period->tanggal_mulai ? date('Y-m-d', strtotime($period->tanggal_mulai)) : '') }}">
                                    @error('tanggal_mulai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="tanggal_selesai" id="tanggal_selesai"
                                        ...
                                        value="{{ old('tanggal_selesai', $period->tanggal_selesai ? date('Y-m-d', strtotime($period->tanggal_selesai)) : '') }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" name="is_closed" id="is_closed" class="form-check-input"
                                            value="1" {{ old('is_closed', $period->is_closed) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                    rows="3">{{ old('keterangan', $period->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
