        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.pkm.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="judul_pkm" id="judul_pkm"
                                        ...
                                        value="{{ old('judul_pkm') }}" placeholder="Masukkan judul PKM" required>
                                    @error('judul_pkm')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="bidang_pkm" id="bidang_pkm"
                                        ...
                                        value="{{ old('bidang_pkm') }}"
                                        placeholder="Contoh: Pendidikan, Ekonomi, Kesehatan" required>
                                    @error('bidang_pkm')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="jenis_pkm" id="jenis_pkm"
                                        ...
                                        <option value="Pengabdian"
                                            {{ old('jenis_pkm') == 'Pengabdian' ? 'selected' : '' }}>Pengabdian</option>
                                        <option value="Pelatihan" {{ old('jenis_pkm') == 'Pelatihan' ? 'selected' : '' }}>
                                            Pelatihan</option>
                                        <option value="Penyuluhan"
                                            {{ old('jenis_pkm') == 'Penyuluhan' ? 'selected' : '' }}>Penyuluhan</option>
                                        <option value="Pendampingan"
                                            {{ old('jenis_pkm') == 'Pendampingan' ? 'selected' : '' }}>Pendampingan
                                        </option>
                                        <option value="Konsultasi"
                                            {{ old('jenis_pkm') == 'Konsultasi' ? 'selected' : '' }}>Konsultasi</option>
                                    </select>
                                    @error('jenis_pkm')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="sumber_dana" id="sumber_dana"
                                        ...
                                        value="{{ old('sumber_dana') }}" placeholder="Contoh: DIKTI, LPPM, CSR" required>
                                    @error('sumber_dana')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="lokasi_kegiatan" id="lokasi_kegiatan"
                                        ...
                                        value="{{ old('lokasi_kegiatan') }}" placeholder="Contoh: Desa X, Kabupaten Y"
                                        required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="url" name="publikasi_link" id="publikasi_link"
                                        ...
                                        value="{{ old('publikasi_link') }}" placeholder="https://...">
