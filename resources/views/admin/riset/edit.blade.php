                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0 fw-bold">
                            <i class="bi bi-pencil-square me-2"></i> Edit Data Penelitian
                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.riset.update', $riset->id) }}" method="POST"
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="judul_riset" id="judul_riset"
                                        ...
                                        value="{{ old('judul_riset', $riset->judul_riset) }}" required>
                                    @error('judul_riset')
                                    ...
                                    <select name="dosen_id" id="dosen_id"
                                        ...
                                        @foreach ($dosens as $dosen)
                                            <option value="{{ $dosen->id }}"
                                                {{ old('dosen_id', $riset->dosen_id) == $dosen->id ? 'selected' : '' }}>
                                    ...
                                    <select name="academic_period_id" id="academic_period_id"
                                        ...
                                        @foreach ($periods as $period)
                                            <option value="{{ $period->id }}"
                                                {{ old('academic_period_id', $riset->academic_period_id) == $period->id ? 'selected' : '' }}>
                                                {{ $period->nama_periode }}
                                                @if ($period->is_active)
                                                    (Aktif)
                                                @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="bidang_riset" id="bidang_riset"
                                        ...
                                        value="{{ old('bidang_riset', $riset->bidang_riset) }}" required>
                                    @error('bidang_riset')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="jenis_riset" id="jenis_riset"
                                        ...
                                        <option value="Penelitian Dasar"
                                            {{ old('jenis_riset', $riset->jenis_riset) == 'Penelitian Dasar' ? 'selected' : '' }}>
                                            Penelitian Dasar</option>
                                        <option value="Penelitian Terapan"
                                            {{ old('jenis_riset', $riset->jenis_riset) == 'Penelitian Terapan' ? 'selected' : '' }}>
                                            Penelitian Terapan</option>
                                        <option value="Pengembangan"
                                            {{ old('jenis_riset', $riset->jenis_riset) == 'Pengembangan' ? 'selected' : '' }}>
                                            Pengembangan</option>
                                    </select>
                                    @error('jenis_riset')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="sumber_dana" id="sumber_dana"
                                        ...
                                        value="{{ old('sumber_dana', $riset->sumber_dana) }}" required>
                                    @error('sumber_dana')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="jumlah_dana" id="jumlah_dana"
                                        ...
                                        value="{{ old('jumlah_dana', $riset->jumlah_dana) }}" required>
                                    @error('jumlah_dana')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="tahun" id="tahun"
                                        ...
                                        value="{{ old('tahun', $riset->tahun) }}" required>
                                    @error('tahun')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="aktif"
                                            {{ old('status', $riset->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="selesai"
                                            {{ old('status', $riset->status) == 'selesai' ? 'selected' : '' }}>Selesai
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="kolaborator" id="kolaborator"
                                        ...
                                        value="{{ old('kolaborator', $riset->kolaborator) }}">
                                    @error('kolaborator')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="url" name="publikasi_link" id="publikasi_link"
                                        ...
                                        value="{{ old('publikasi_link', $riset->publikasi_link) }}">
                                    ...
                                    @if ($riset->file_laporan)
                                        <div class="mb-2">
                                            <div class="alert alert-info py-2">
                                                ...
                                                File saat ini:
                                                <a href="{{ Storage::url($riset->file_laporan) }}" target="_blank"
                                                    class="text-primary">
                                                    {{ basename($riset->file_laporan) }}
                                                </a>
                                            </div>
                                        </div>
                                    @endif
