            ...
            <div class="col-md-8 mx-auto">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted">Informasi lengkap sertifikasi profesional</p>
                    </div>
                    <div>
                        <a href="{{ route('admin.sertifikasi.edit', $sertifikasi->id) }}" class="btn btn-warning">
                            ...
                            <div class="col-md-6">
                                <table class="table table-borderless">
                                    <tr>
                                        ...
                                        <td>: <strong>{{ $sertifikasi->dosen->nama ?? '-' }}</strong></td>
                                    </tr>
                                    <tr>
                                        <th>NIDN</th>
                                        <td>: {{ $sertifikasi->dosen->nidn ?? '-' }}</td>
                                    </tr>
                                    <tr>
