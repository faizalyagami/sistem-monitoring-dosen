            ...
            <div class="col-md-8 mx-auto">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted">Informasi lengkap Sertifikat Pendidik Profesional</p>
                    </div>
                    <div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-borderless">
                                    <tr>
                                        ...
                                        <td>: <strong>{{ $sipp->dosen->nama ?? '-' }}</strong></td>
                                    </tr>
                                    <tr>
                                        <th>NIDN</th>
                                        <td>: {{ $sipp->dosen->nidn ?? '-' }}</td>
                                    </tr>
                                    <tr>
                                        <th>No. Registrasi</th>
                            ...
                            <div class="col-md-6">
                                <table class="table table-borderless">
                                    <tr>
                                        <th width="150">Bidang Keilmuan</th>
