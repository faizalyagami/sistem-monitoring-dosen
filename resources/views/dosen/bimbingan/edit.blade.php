        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dosen.bimbingan.update', $bimbingan->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="semester" id="semester"
                                    ...
                                    <option value="ganjil"
                                        {{ old('semester', $bimbingan->semester) == 'ganjil' ? 'selected' : '' }}>Ganjil
                                    </option>
                                    <option value="genap"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="tahun_akademik" id="tahun_akademik"
                                    ...
                                    value="{{ old('tahun_akademik', $bimbingan->tahun_akademik) }}" required>
