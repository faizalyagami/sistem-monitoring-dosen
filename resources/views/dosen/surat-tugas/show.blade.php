            ...
            <div class="col-md-8 mx-auto">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted">Informasi lengkap surat tugas Anda</p>
                    </div>
                    <div>
                        <a href="{{ route('dosen.surat-tugas.edit', $suratTugas->id) }}" class="btn btn-warning">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-borderless">
                                    <tr>
                                        <th width="150">Nama Surat Tugas</th>
                                        <td>: <strong>{{ $suratTugas->nama_surat_tugas }}</strong></td>
                                    </tr>
                                    <tr>
                                        <th>No. Surat</th>
                                    ...
                                    <tr>
                                        <th>Tanggal Surat</th>
                                        <td>:
                                            {{ $suratTugas->tanggal_surat_tugas ? date('d/m/Y', strtotime($suratTugas->tanggal_surat_tugas)) : '-' }}</span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-6">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {{ $suratTugas->academicPeriod->nama_periode ?? '-' }}</span></td>
                                    </tr>
                                    <tr>
                                        <th>File Surat</th>
                                        <td>:
